...
if (isset($_GET['respond_health'])) {
	$dispatch_id = $_GET['respond_health'];
	$query = "UPDATE `dispatch` SET h_officer='responded' WHERE id='$dispatch_id'";
...
if (isset($_GET['respond_police'])) {
	$dispatch_id = $_GET['respond_police'];
	$query = "UPDATE `dispatch` SET p_officer='responded' WHERE id='$dispatch_id'";
	$update_row = $mysqli->query($query) or die($mysqli->error.__LINE__);
	if ($update_row) {
		$message = 'Dispatch updated successfully';
	}
...
if (isset($_GET['respond_fire'])) {
	$dispatch_id = $_GET['respond_fire'];
	$query = "UPDATE `dispatch` SET f_fighter='responded' WHERE id='$dispatch_id'";
	$update_row = $mysqli->query($query) or die($mysqli->error.__LINE__);
	if ($update_row) {
		$message = 'Dispatch updated successfully';
	}
